    ...
    <div class="content">
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <div class="container">
        <div class="col-md-6">
              <form action="{{route('admin.company.save')}}" method="Post" enctype="multipart/form-data">
    @csrf
     ...
     <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                @error('name')<p class="alert-danger"></p>{{$message}} @enderror
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
                ...
                @error('email')<p class="alert-danger"></p>{{$message}} @enderror
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
                ...
                @error('logo')<p class="alert-danger"></p>{{$message}} @enderror
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
                ...
                @error('website')<p class="alert-danger"></p>{{$message}} @enderror
            </div>
        </div>
